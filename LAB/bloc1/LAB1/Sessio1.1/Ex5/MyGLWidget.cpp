...
void MyGLWidget::creaBuffers ()
{
  ...
  //Triangle
  glm::vec3 Verticest[3];  // Nou vèrtexs amb X, Y i Z
  Verticest[0] = glm::vec3(0.0, 0.0, 0.0);
  Verticest[1] = glm::vec3(1.0, 0.0, 0.0);
  Verticest[2] = glm::vec3(0.5, 1.0, 0.0);
