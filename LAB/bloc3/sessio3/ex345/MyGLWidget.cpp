...
void MyGLWidget::initializeGL ()
{
  ...
  cFoc = glm::vec3(1.0, 1.0, 1.0);
  pFoc = glm::vec3(0.0, -0.5, 0.0);
  glUniform3fv(colFocusLoc, 1, &cFoc[0]);
  glUniform3fv(posFocusLoc, 1, &pFoc[0]);
  glUniform1i(tipusFocusLoc, focusEsc);
}
...
//    }
    ...
    case Qt::Key_L: {
      if(cFoc[0] == 1.0) {
          cFoc = glm::vec3(0.0, 0.0, 0.0);
      }
      else cFoc = glm::vec3(1.0, 1.0, 1.0);
...
void MyGLWidget::calculaCapsaModel ()
{
  ...
  centreBasePatr[0] = centrePatr[0];
  centreBasePatr[1] = miny;
  centreBasePatr[2] = centrePatr[2];
}
...
//  float shin = 100;
  ...
  // Definim el material del terra --> blau plàstic
...
void MyGLWidget::carregaShaders()
{
  ...
  tipusFocusLoc = glGetUniformLocation (program->programId(), "focusEscena");
}
